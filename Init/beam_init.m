...
classdef beam_init
    ...
    methods 
        ...
        trproduct=1.872e-18*sqrt(s.n_cycles/3);% For const peak Intensity leading to 1.24% ionization @ 3 cycles
        s.r_mode=trproduct/s.t_fwhm;%factor*(130e-6);%[m] beam radius
